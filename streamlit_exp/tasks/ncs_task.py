...
def load_ncs_items() -> List[Dict[str, Any]]:
    ...
    items: List[Dict[str, Any]] = [
        ...
        # -------------------------
        {
            ...
            "session_id": 2,
            "domain": "session2",
            "instruction": "팀원과 회의실 일정을 고려하여 팀회의 일정을 잡아야한다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    "title": "",
                    "bullets": [
                        "팀원 일정: A - 월,화 오전 가능, 수 종일 가능 / B - 화,수 오후 가능, 화 오전 온라인 가능 / C - 월, 화 오전 가능, 수 오후 온라인 가능",
                        "회의실 일정: 월 - 종일 사용 / 화 - 오전 사용 / 수 - 오전 사용"
                        "단, B는 필수 인원으로 오프라인 참석이 필수",
                    ],
                },
            ],
            "table_spec": {},
            "question": "가장 알맞은 회의 일정은 언제인가(단, 온라인 가능 시간은 온라인 참여)?",
            "options": _options_dict(
                "월요일 오전 회의실을 예약한다.",
                "화요일 오전 회의실을 예약한다.",
                "수요일 오후 회의실을 예약한다.",

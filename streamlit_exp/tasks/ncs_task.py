    ...
    items: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "info_blocks": [
                ...
                {
                    "title": "결정 목표",
                    "bullets": ["아래 ‘종합점수(가중치 반영·계산됨)’가 가장 높은 후보지를 선택한다."],
                },
                {
        ...
        # -------------------------
        {
            ...
            "info_blocks": [
                {
                    "title": "규칙(결정 목표)",
                    "bullets": ["사실 확인 없이 결론을 일반화해 판단을 흐릴 수 있는 발언을 고른다."],
                }
            ],
        ...
        },
        {
            ...
            "info_blocks": [
                {
                    "title": "결정 목표",
                    "bullets": ["현재 추세가 유지된다고 가정할 때 가장 합리적인 변화를 고른다."],
                }
            ],
            "chart_spec": {
                "data": [
        ...
        },
        {
            ...
            "question": "마감과 영향도를 함께 고려할 때, 무엇을 먼저 처리하는 것이 가장 합리적인가?",
            "options": _options_dict(
                "C → A → B",
                "A → C → B",
                "A → B → C",
        ...
        },
        {
            ...
            "question": "요약을 바탕으로, 다음 프로젝트에서 우선 개선해야 할 핵심 원인은 무엇인가?",
            "options": _options_dict(
                "인력 부족",
                "예산 부족",
                "시장 분석 미흡",
        ...
        },
        {
            ...
            "info_blocks": [
                {
                    "title": "결정 목표",
                    "bullets": ["혼란을 줄이면서 도입을 진행할 수 있는 조치를 선택한다."],
                }
            ],
            "question": "규칙에 따라 지금 무엇을 해야 하는가?",
            "options": _options_dict(

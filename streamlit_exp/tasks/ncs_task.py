...
def load_ncs_items() -> List[Dict[str, Any]]:
    ...
    items: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "session_id": 1,
            "domain": "session1",
            "instruction": "오늘 해야 할 작업의 순서를 정리하고 있다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
        ...
        },
        {
            ...
            "session_id": 2,
            "domain": "session2",
            "instruction": "PC 사용 기록(로그) 조회 요청이 들어왔다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    ...
                    "bullets": [
                        "업무 목적이 명확해야 한다(O).",
                        "조회 기간은 최근 7일 이내, 사고 조사 목적의 경우 30일 허용",
                        "사용 기록 조회 시 보안팀 사전 결재가 필요하다.",
                    ],
                },
            ],
            "table_spec": {},
            "question": "다음 중 조회가 가능한 요청은 무엇인가?",
            "options": _options_dict(
                "요청 A: 사건 조사를 위해 지는 30일간 접속 기록이 필요합니다. 보안팀 결재는 추후 예정",
                "요청 B: 관리자 사용가 필요합니다. 보안팀 결재는 승인 처리 되었고 14일치가 필요합니다.",
                "요청 C: 회원 사용 로그 7일치가 필요합니다.",
                "요청 D: 보안팀 결재를 받았습니다. 보안 사고 관련 30일 로그 기록이 필요합니다.",
                "요청 E: 보안팀입니다. PC 사용기록 7일치가 필요합니다.",
            ),
            "answer_key": "4",
        },
        {
            ...
            "session_id": 2,
            "domain": "session2",
            "instruction": "파트타이머 근무자의 초과근무 결재를 진행해야 한다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    "title": "초과근무 신청 방법",
                    "bullets": [
                        "초과 근무는 사전 신청을 원칙으로 합니다. 미리 말씀해주세요.",
                        "초과 근무는 주당 총 근무시간 52시간이 넘지 않도록 해주세요.",
                        "단, 고객 응대 및 매니저 판단 하에 사후 신청 가능합니다.",
                    ],
                },
            ],
            "table_spec": {},
            "question": "다음 중 결재가 불가능한 신청 내역은 무엇인가?",
            "options": _options_dict(
                "A: 내일 초과근무 2시간 신청합니다(주간 근무 시간: 48시간)",
                "B: 어제 매니저님 요청으로 4시간 초과 근무 했습니다(주간 근무 시간: 25시간)",
                "C: 저번주에 4시간 초과 근무 했는데 신청을 누락했습니다(주간 근무 시간: 48시간)",
                "D: 고객 응대가 늦어서 초과 근무 1시간 진행했습니다(주간 근무 시간: 52시간)",
                "E: 다음주에 초과근무 3시간 신청합니다(주간 근무시간: 25시간)",
            ),
            "answer_key": "3",
        },
            ...
            "info_blocks": [
                {
                    ...
                    "bullets": [
                        "추가 피해를 막는 조치를 먼저 한다.",
                        "접속 기록 확인, 알림 설정 등을 한다.",
                    ],
                },
            ],
            "table_spec": {},
            "question": "다음중 가장 적절한 대처 행동은 무엇인가?",
            "options": _options_dict(
                "비밀번호를 변경하고 모든 기기 로그아웃을 진행한다.",
                "비밀번호 변경, 2차 비밀번호를 설정하고 로그인 알림 설정 후 보안 센터에 문의한다.",
                "로그인 기록 확인 후 비밀번호를 변경한다.",
                "범인을 잡기 위해 비밀번호는 두고 로그인 알림을 설정한다.",
                "주변 사람에게 보안 문제의 심각성을 전달한다.",
            ),
            "answer_key": "2",
        },
        {
            ...
            "session_id": 3,
            "domain": "session3",
            "instruction": "고객 문의 알림이 쌓여있다. 업무 효율성을 위해 처리 순서를 결정해야한다. ",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    "title": "처리 순서 기준",
                    "bullets": [
                        "개인정보/보안 위험, 결제 관련 문의는 1순위 처리 알림이다.",
                        "같은 유형이면 더 빠른 시각의 알림을 먼저 확인한다.",
                    ],
                },
            ],
            "table_spec": {},
            "question": "다음 중 5순위로 처리해야할 문의는 무엇인가?",
            "options": _options_dict(
                "A: 어제 구매한 상품에 하자가 있는것 같습니다(시간: 14:00).",
                "B: 의심스러운 로그인 안내를 받았습니다(시간: 07:00).",
                "C: 이중 결제가 됐어요 환불 해주세요(시간: 10:00)",
                "D: 상품 사용법을 모르겠어요 안내 부탁드립니다(시간: 17:00)",
                "E: 제가 구매한적 없는 상품이 결제가 됐습니다(시간: 15:00)",
            ),
            "answer_key": "4",
        },
        {
            ...
            "session_id": 3,
            "domain": "session3",
            "instruction": "배달을 해야한다. 어떤 배송지 부터 배달을 해야할지 순서를 정해야한다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    "title": "배달 위치",
                    "bullets": [
                        "A: 현재 위치 기준 200m, C와 거리 50m",
                        "B: 현재 위치 기준 150m, C와 거리 100m",
                        "C: 현재 위치 기준 300m",
                        "A에서 B로 이동하기 위해서는 C를 지나쳐야 한다."
                    ],
                },
            ],
            "table_spec": {},
            "question": "다음 중 어떤 위치부터 배달해야 가장 짧은 거리가 되는가?",
            "options": _options_dict(
                "A",
                "B",
                "C",
        ...
        },
        {
            ...
            "session_id": 3,
            "domain": "session3",
            "instruction": "약속 시간에 늦을 것 같아 상대에게 메시지를 보내야 한다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
            ...
            "table_spec": {},
            "question": "다음 중 가장 적절한 메시지 내용은 무엇인가?",
            "options": _options_dict(
                "죄송합니다 차가 막혀서 늦을 것 같습니다. 근처 가면 연락드리겠습니다.",
                "죄송합니다 오래 기다리게 해드려서 제가 다 마음이 아프네요. 근처 가면 연락드리겠습니다.",
                "죄송합니다. 10분 정도 늦을 것 같아요 늦게 되어 제가 다 마음이 안좋네요.",
                "죄송합니다. 지하철 연착으로 10분 정도 늦을 것 같습니다.",
                "죄송합니다. 시간을 헷갈렸습니다. 곧 가겠습니다.",
            ),
            "answer_key": "4",
        },
        {
            ...
            "session_id": 3,
            "domain": "session3",
            "instruction": "여행 계획을 세우고 있다. 숙소를 선택해야하는데 숙소의 종류가 다양하다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    "title": "숙소 선택 기준 및 예산",
                    "bullets": [
                        "예산: 100만원 / 같은 조건이라면 예산이 적을 수록 좋다.",
                        "숙소는 공항과 거리가 가까워야 한다.",
                        "관광지 까지 거리는 가까우면 좋으나 필수는 아니다."
                    ],
                },
            ],
            "table_spec": {},
            "question": "다음 중 가장 적절한 숙소는 무엇인가?",
            "options": _options_dict(
                "A: 100만원 / 공항까지 1km / 관광지까지 2km",
                "B: 80만원 / 공항까지 1.5km / 관광지까지 2km",
                "C: 95만원 / 공항까지 2km / 관광지까지 1km",
                "D: 100만원 / 공항까지 0.5km / 관광지까지 3km",
                "E: 80만원 / 공항까지 1km / 관광지까지 1km",
            ),
            "answer_key": "4",
        },
    ]

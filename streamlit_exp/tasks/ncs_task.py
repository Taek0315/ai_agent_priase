...
def load_ncs_items() -> List[Dict[str, Any]]:
    ...
    items: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "session_id": 1,
            "domain": "session1",
            "instruction": "동아리 회계 정산을 위해 단체 채팅방에 영수증 사진을 공유하려고 한다. 사진에 연락처가 함께 찍혀 있다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {
                    ...
                    "bullets": [
                        ...
                        "마스킹이 어렵다면 개인정보가 없는 다른 자료로 대체한다.",
                    ],
                },
            ],
            "table_spec": {},
            ...
            "options": _options_dict(
                "그대로 단체 채팅방에 사진을 올린다.",
                "연락처가 보이는 부분을 가린 뒤 사진을 올린다.",
                "단체 채팅방 대신 개인 메시지로 아무에게나 보낸다.",
                "연락처가 보이니 정산 공유를 하지 않는다.",
                "연락처가 있어도 영수증이 중요하므로 그냥 올린다.",
            ),
            "answer_key": "2",
        },
        {
        ...
        },
        {
            ...
            "session_id": 2,
            "domain": "session2",
            "instruction": "공동 구매 채팅방에 ‘배송 지연’ 공지를 1개 올리려 한다. 현재 지연은 해결되어 정상화된 상태다.",
            "stimulus_type": "text",
            "stimulus_text": "",
            "info_blocks": [
                {

...
def _build_credentials() -> Credentials:
    ...
    # \n 이스케이프 형태면 실제 개행으로 교체 (삼중따옴표면 영향 없음)
...
def get_google_sheet(worksheet: str | int | None = None) -> gspread.Worksheet:
    """
    worksheet:
      - None  -> secrets의 [google_sheet.worksheet] 또는 'resp' 기본값
      - str   -> 해당 이름 워크시트
      - int   -> 인덱스(0-based)
    """
...
def append_row_to_sheet(row_data: list, worksheet: str | int | None = None) -> None:
